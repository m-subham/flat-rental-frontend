  ...
  return (
    <footer className="Footer stick-bottom  text-center text-white mx-auto" style={{ background: "#5595f4",width:"96%" }}>
      ...
      <div className="container-fluid p-1"  >
        ...
        <a className="btn btn-outline-light btn-floating m-2" href="https://www.instagram.com/sub_boy_am" type="button"
      ...
      <div>
        ...
        <p>Contact No: +916371146242    &ensp; &ensp; &ensp;    Gmail: flatrental@gmail.com</p>

      </div>


      <div className="text-center p-1" >
        © 2024 Copyright by Flat Rental        
      </div>
<br />
    </footer>
  );
